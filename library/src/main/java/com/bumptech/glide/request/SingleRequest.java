...
public final class SingleRequest<R> implements Request,
  ...
  public void begin() {
    ...
    // the new load.
    //如果这个Request已经请求成功，后面类似notifydatasetchanged不会再次请求，直接从前一次的请求设置数据
    // ，这样的话，如果在这个过程中图片的大小改变的话，需要手动的clear后，才行（待验证）
  ...
  public void onSizeReady(int width, int height) {
    ...
    //engine是在Glide初始化的时候创建的，在GlideBuilder中，默认是Engine.java
